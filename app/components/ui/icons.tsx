...
// Custom LinkedIn icon based on your SVG
export const LinkedinCustom = forwardRef<SVGSVGElement, LucideProps>(
...
LinkedinCustom.displayName = 'LinkedinCustom';

// StackOverflow icon (custom)
export const StackOverflow = forwardRef<SVGSVGElement, LucideProps>(
  ({ size = 24, strokeWidth = 2, absoluteStrokeWidth, ...props }, ref) => {
    return (
      <svg
        ref={ref}
      ...
      >
        <path
          d="M84.4 93.8V70.6h7.7v30.9H22.6V70.6h7.7v23.2h54.1z"
          fill="currentColor"
        />
        <path
